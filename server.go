...
func NewServer(flGraphPath string, autoRestart, enableCors bool, dns ListOpts, volumeSetFactory VolumeSetFactory) (*Server, error) {
	...
	runtime.SetVolumeSetFactory(volumeSetFactory)
	srv := &Server{
		runtime:     runtime,
